...
void oGFX::IndirectCommandsHelper(Node * node, std::vector<oGFX::IndirectCommand>& m_DrawIndirectCommandsCPU, std::vector<oGFX::IndirectCommand>& indirectDebugCommandsCPU, uint32_t & m)
{	
	if (node->meshes.size())
	{
